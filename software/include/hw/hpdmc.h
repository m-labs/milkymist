...
#define HPDMC_CLKDELAY_CE	(0x080)
#define HPDMC_CLKDELAY_INC	(0x100)
#define HPDMC_CLKDELAY_RDY	(0x200)

#define HPDMC_PLL1_LOCKED	(0x400)
#define HPDMC_PLL2_LOCKED	(0x800)
