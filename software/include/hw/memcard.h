...
#define CSR_MEMCARD_CLK2XDIV		MMPTR(0xe0007000)

#define CSR_MEMCARD_ENABLE		MMPTR(0xe0007004)
...
#define CSR_MEMCARD_PENDING		MMPTR(0xe0007008)
...
#define CSR_MEMCARD_START		MMPTR(0xe000700c)

#define MEMCARD_START_CMD_RX		(0x1)
#define MEMCARD_START_DAT_RX		(0x2)

#define CSR_MEMCARD_CMD			MMPTR(0xe0007010)
#define CSR_MEMCARD_DAT			MMPTR(0xe0007014)
