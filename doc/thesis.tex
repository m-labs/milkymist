...
\caption{Disposition of the channels within the texture, vertical wrap.}\label{fig:chdispvwrap}
\end{figure}
...
\caption{Disposition of the channels within the texture, horizontal wrap.}\label{fig:chdisphwrap}
\end{figure}
...
\left\lfloor \frac{H}{N_{l}} \right\rfloor + 1 \not \equiv 0 \pmod{\frac{N_{c}}{N_{l}}}
\end{cases}
}
\end{equation}
...
\left\lfloor \frac{H \cdot (V-1)}{N_{l}} \right\rfloor + 1 \not \equiv 0 \pmod{\frac{N_{c}}{N_{l}}}
\end{cases}
}
\end{equation}
\end{itemize}
