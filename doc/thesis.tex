...
Equations from the patches need to be compiled and scheduled before they can be evaluated by the PFPU. These operations take place on the CPU core of the SoC (section~\ref{sec:mico32}).
