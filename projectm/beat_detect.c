...
void initBeatDetect()
{
  ...
  beat_val=(double *)wipemalloc(32*sizeof(double));
  beat_att=(double *)wipemalloc(32*sizeof(double));
  beat_variance=(double *)wipemalloc(32*sizeof(double));
...
void getBeatVals(projectM_t *pm, double *vdataL,double *vdataR)
{
  int linear=0;
  int x,y;
  double temp2=0;
